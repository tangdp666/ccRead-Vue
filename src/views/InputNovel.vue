...
const getNovelList = async () => {
    ...
    let result1 = await axios.post("/ccread-book/book/home/getNovelListByHome",
    {
        novelName:route.query.val
    })
    let result2 = await axios.post("/ccread-book/book/home/getNovelListByHome",
    {
        author:route.query.val
    })
    let arrs1 = result1.data.data
    let arrs2 = result2.data.data
    novelListInfo.value = [...new Set(arrs1.concat(arrs2))]
